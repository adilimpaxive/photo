package com.photo.viedo.maker.photomaker.filters;
...
public class FilterViewAdapter extends RecyclerView.Adapter<FilterViewAdapter.ViewHolder> {
    ...
    private Filterlisnter mFilterListener;
    private List<Pair<String, PhotoFilter>> mPairList = new ArrayList<>();



    public FilterViewAdapter(Filterlisnter filterlisnter){
        mFilterListener = filterlisnter;
        setupFilters();
    }
